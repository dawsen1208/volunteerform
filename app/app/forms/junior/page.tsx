...
export default function JuniorFormPage() {
  ...
  const onFinish = async (values: IFormData) => {
    try {
      ...
      const res = await fetch('/api/forms/submit', {
        ...
        body: JSON.stringify({ formType: 'junior', data: values }),
      });
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <Title level={2} className="mb-6 text-center">专科志愿单</Title>
      <Form
        form={form}
        layout="vertical"
        onFinish={onFinish}
